  ...
  Widget build(BuildContext context) {
    return const SingleChildScrollView(
      child: Column(children: [
        ...
        Padding(
            padding: EdgeInsets.symmetric(vertical: 0,horizontal: 15),
            child: Text('Diab-Gulzar is a comprehensive health management app designed to help you take control of your diabetes. Easily monitor and track essential health parameters, medications, and lifestyle habits for effective diabetic management.')
        ),
        Padding(
          padding: EdgeInsets.only(left: 15,right: 15,top: 25,bottom: 10),
          child: Row(
            ...
            child: SizedBox(
                child: Column(
                  children: [
                    FormattedStringWithLink(
                        bold: "Dashboard:",
                        remaining: "\n* Overview of your daily stats, including blood sugar levels, blood pressure, weight, and HbA1c.\n* Quick access to important sections.",
                        NumberIn: '1.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Tracking:",
                        remaining: "",
                        ...
                        child: SizedBox(
                            child: Column(
                              children: [
                                FormattedStringWithLink(
                                    bold: "Blood Sugar:",
                                    remaining: "Log your blood glucose readings throughout the day.",
                                    NumberIn: 'a.', urlString: '', link: ''),
                                FormattedStringWithLink(
                                    bold: "Blood Pressure:",
                                    remaining: "Monitor and record your blood pressure regularly.",
                                    NumberIn: 'b.', urlString: '', link: ''),
                                FormattedStringWithLink(
                                    bold: "Weight:",
                                    remaining: "Track your weight to maintain a healthy lifestyle.",
                                    NumberIn: 'c.', urlString: '', link: ''),
                                FormattedStringWithLink(
                                    bold: "Food:",
                                    remaining: "Log your meals to manage your diet effectively.",
                                    NumberIn: 'd.', urlString: '', link: ''),
                                FormattedStringWithLink(
                                    bold: "Water Intake:",
                                    remaining: "Ensure proper hydration by recording your water intake.",
                                    NumberIn: 'e.', urlString: '', link: ''),
                                FormattedStringWithLink(
                                    bold: "HbA1c:",
                                    remaining: "Keep track of your HbA1c levels for a comprehensive view of your long-term glucose control.",
                                    NumberIn: 'f.', urlString: '', link: ''),
                              ],
                            ))),
                    FormattedStringWithLink(
                        bold: "Lab Tests:",
                        remaining: "\nInput and track your lab test results. Stay informed about your overall health.",
                        NumberIn: '3.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Medication:",
                        remaining: "\nManage your medications with a built-in tracker. Set reminders for doses.",
                        NumberIn: '4.', urlString: '', link: ''),
                  ],
                ))),
        Padding(
            ...
            child: SizedBox(
                child: Column(
                  children: [
                    FormattedStringWithLink(
                        bold: "Adding Data:",
                        remaining: "\n* Tap on the "+" icon on the dashboard to add new data.\n* Choose the category (Blood Sugar, Blood Pressure, etc.).\n* Enter the relevant details and save.",
                        NumberIn: '1.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Viewing History:",
                        remaining: "\n* Navigate to specific sections to view historical data.\n* Use the calendar to jump to a specific date.",
                        NumberIn: '2.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Medication Reminders:",
                        remaining: "\n* Set up medication reminders in the Medication section.\n* Receive notifications to take your medications on time.",
                        NumberIn: '3.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Charts and Insights:",
                        remaining: "\n* Access charts to visualize trends over time.\n* Gain insights into your health patterns.",
                        NumberIn: '4.', urlString: '', link: ''),
                    FormattedStringWithLink(
                        bold: "Profile and Settings:",
                        remaining: "\n* Personalize your profile with essential information.\n* Adjust app settings to suit your preferences.",
                        NumberIn: '5.', urlString: '', link: '')
                  ],
                ))),
        Padding(
        ...
        Padding(
            padding: EdgeInsets.symmetric(vertical: 0,horizontal: 15),
            child: Text('* Regularly update your data for accurate insights.\n* Utilize reminders to stay on track with medications and lifestyle habits.\n* Review charts and trends to understand your health journey.')
        ),
        Padding(
          padding: EdgeInsets.only(left: 15,right: 15,top: 25,bottom: 10),
          child: Row(
        ...
        Padding(
            padding: EdgeInsets.symmetric(vertical: 0,horizontal: 15),
            child: Text('* For any questions or issues, visit our support section.\n* We value your feedback! Help us improve by sharing your thoughts.\n\n'
            )),
        Padding(
            padding: EdgeInsets.symmetric(vertical: 0,horizontal: 15),
            child: Text('Thank you for choosing Diab-Gulzar! We are here to support you on your journey to better health.\n\n\n')
        ),
